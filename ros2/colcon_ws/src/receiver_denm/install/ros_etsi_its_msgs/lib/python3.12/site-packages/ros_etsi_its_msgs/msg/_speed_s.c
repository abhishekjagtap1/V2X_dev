...
bool ros_etsi_its_msgs__msg__speed__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_etsi_its_msgs.msg._speed.Speed", full_classname_dest, 34) == 0);
  }
  ros_etsi_its_msgs__msg__Speed * ros_message = _ros_message;
  {  // value
...
PyObject * ros_etsi_its_msgs__msg__speed__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_etsi_its_msgs.msg._speed");
