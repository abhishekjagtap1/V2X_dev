...
bool ros_etsi_its_msgs__msg__movement_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_etsi_its_msgs.msg._movement_event.MovementEvent", full_classname_dest, 51) == 0);
  }
  ros_etsi_its_msgs__msg__MovementEvent * ros_message = _ros_message;
  {  // event_state
    ...
    rosidl_runtime_c__String__assign(&ros_message->event_state, PyBytes_AS_STRING(encoded_field));
  ...
  {  // min_end_time
    ...
    ros_message->min_end_time = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * ros_etsi_its_msgs__msg__movement_event__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_etsi_its_msgs.msg._movement_event");
  ...
  {  // event_state
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->event_state.data,
      strlen(ros_message->event_state.data),
      "replace");
    if (!field) {
      return NULL;
    }
  ...
  {  // min_end_time
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->min_end_time);
    {
