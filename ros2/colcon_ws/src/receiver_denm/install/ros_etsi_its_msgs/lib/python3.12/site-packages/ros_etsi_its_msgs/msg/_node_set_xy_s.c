...
bool ros_etsi_its_msgs__msg__node_set_xy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_etsi_its_msgs.msg._node_set_xy.NodeSetXY", full_classname_dest, 44) == 0);
  }
  ros_etsi_its_msgs__msg__NodeSetXY * ros_message = _ros_message;
  {  // x
  ...
  {  // pos
    ...
    if (!ros_etsi_its_msgs__msg__reference_position__convert_from_py(field, &ros_message->pos)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of NodeSetXY */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_etsi_its_msgs.msg._node_set_xy");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NodeSetXY");
  ...
  {  // pos
    PyObject * field = NULL;
    field = ros_etsi_its_msgs__msg__reference_position__convert_to_py(&ros_message->pos);
    if (!field) {
      return NULL;
    }
    {
