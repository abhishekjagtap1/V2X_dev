...
bool ros_etsi_its_msgs__msg__sensor_information__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_etsi_its_msgs.msg._sensor_information.SensorInformation", full_classname_dest, 59) == 0);
  }
  ros_etsi_its_msgs__msg__SensorInformation * ros_message = _ros_message;
  {  // sensor_id
  ...
  {  // detection_area
    PyObject * field = PyObject_GetAttrString(_pymsg, "detection_area");
    if (!field) {
      return false;
    }
    if (!ros_etsi_its_msgs__msg__vehicle_sensor__convert_from_py(field, &ros_message->detection_area)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of SensorInformation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_etsi_its_msgs.msg._sensor_information");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SensorInformation");
  ...
  {  // detection_area
    PyObject * field = NULL;
    field = ros_etsi_its_msgs__msg__vehicle_sensor__convert_to_py(&ros_message->detection_area);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "detection_area", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
