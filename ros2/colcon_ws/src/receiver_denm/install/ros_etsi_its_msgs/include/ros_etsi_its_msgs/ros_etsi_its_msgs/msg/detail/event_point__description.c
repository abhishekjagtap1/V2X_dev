...
static char ros_etsi_its_msgs__msg__EventPoint__FIELD_NAME__event_position[] = "event_position";
static char ros_etsi_its_msgs__msg__EventPoint__FIELD_NAME__event_delta_time[] = "event_delta_time";
static char ros_etsi_its_msgs__msg__EventPoint__FIELD_NAME__information_quality[] = "information_quality";

static rosidl_runtime_c__type_description__Field ros_etsi_its_msgs__msg__EventPoint__FIELDS[] = {
  {
    {ros_etsi_its_msgs__msg__EventPoint__FIELD_NAME__event_position, 14, 14},
    {
  ...
  {
    {ros_etsi_its_msgs__msg__EventPoint__FIELD_NAME__event_delta_time, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {ros_etsi_its_msgs__msg__EventPoint__FIELD_NAME__information_quality, 19, 19},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ros_etsi_its_msgs__msg__EventPoint__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {ros_etsi_its_msgs__msg__DeltaReferencePosition__TYPE_NAME, 44, 44},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {ros_etsi_its_msgs__msg__EventPoint__FIELDS, 3, 3},
    },
    {ros_etsi_its_msgs__msg__EventPoint__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = ros_etsi_its_msgs__msg__InformationQuality__get_type_description(NULL)->type_description.fields;
...
ros_etsi_its_msgs__msg__EventPoint__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ros_etsi_its_msgs__msg__EventPoint__get_individual_type_description_source(NULL),
    sources[1] = *ros_etsi_its_msgs__msg__DeltaReferencePosition__get_individual_type_description_source(NULL);
    sources[2] = *ros_etsi_its_msgs__msg__InformationQuality__get_individual_type_description_source(NULL);
