...
{
  new (message_memory) ros_etsi_its_msgs::msg::Curvature(_init);
}

void Curvature_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_etsi_its_msgs::msg::Curvature *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Curvature_message_member_array[2] = {
  {
    ...
    offsetof(ros_etsi_its_msgs::msg::Curvature, value),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_etsi_its_msgs::msg::Curvature, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Curvature_message_members = {
  ...
  2,  // number of fields
  sizeof(ros_etsi_its_msgs::msg::Curvature),
...
{
  return &::ros_etsi_its_msgs::msg::rosidl_typesupport_introspection_cpp::Curvature_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_etsi_its_msgs, msg, Curvature)() {
  return &::ros_etsi_its_msgs::msg::rosidl_typesupport_introspection_cpp::Curvature_message_type_support_handle;
}
