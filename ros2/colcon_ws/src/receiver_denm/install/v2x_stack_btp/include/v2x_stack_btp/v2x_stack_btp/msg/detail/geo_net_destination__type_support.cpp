...
{
  new (message_memory) v2x_stack_btp::msg::GeoNetDestination(_init);
}

void GeoNetDestination_fini_function(void * message_memory)
{
  auto typed_message = static_cast<v2x_stack_btp::msg::GeoNetDestination *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GeoNetDestination_message_member_array[3] = {
  {
    ...
    offsetof(v2x_stack_btp::msg::GeoNetDestination, type),  // bytes offset in struct
  ...
  },
  {
    ...
    8,  // array size
    false,  // is upper bound
    offsetof(v2x_stack_btp::msg::GeoNetDestination, address),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<v2x_stack_btp::msg::GeoNetArea>(),  // members of sub message
    false,  // is key
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_stack_btp::msg::GeoNetDestination, area),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GeoNetDestination_message_members = {
  ...
  3,  // number of fields
  sizeof(v2x_stack_btp::msg::GeoNetDestination),
...
{
  return &::v2x_stack_btp::msg::rosidl_typesupport_introspection_cpp::GeoNetDestination_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2x_stack_btp, msg, GeoNetDestination)() {
  return &::v2x_stack_btp::msg::rosidl_typesupport_introspection_cpp::GeoNetDestination_message_type_support_handle;
}
