...
#ifndef V2X_STACK_BTP__MSG__DETAIL__UDP_DATA_IND_HDR__TRAITS_HPP_
#define V2X_STACK_BTP__MSG__DETAIL__UDP_DATA_IND_HDR__TRAITS_HPP_
...
// Member 'location'
#include "v2x_stack_btp/msg/detail/location__traits.hpp"
// Member 'area'
#include "v2x_stack_btp/msg/detail/area__traits.hpp"
...
inline void to_yaml(
  const v2x_stack_btp::msg::UDPDataIndHdr & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const v2x_stack_btp::msg::UDPDataIndHdr & msg)
{
  return v2x_stack_btp::msg::to_yaml(msg);
}

template<>
inline const char * data_type<v2x_stack_btp::msg::UDPDataIndHdr>()
{
  return "v2x_stack_btp::msg::UDPDataIndHdr";
}

template<>
inline const char * name<v2x_stack_btp::msg::UDPDataIndHdr>()
{
  return "v2x_stack_btp/msg/UDPDataIndHdr";
}

template<>
struct has_fixed_size<v2x_stack_btp::msg::UDPDataIndHdr>
  : std::integral_constant<bool, has_fixed_size<v2x_stack_btp::msg::Area>::value && has_fixed_size<v2x_stack_btp::msg::Location>::value> {};

template<>
struct has_bounded_size<v2x_stack_btp::msg::UDPDataIndHdr>
  : std::integral_constant<bool, has_bounded_size<v2x_stack_btp::msg::Area>::value && has_bounded_size<v2x_stack_btp::msg::Location>::value> {};

template<>
struct is_message<v2x_stack_btp::msg::UDPDataIndHdr>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // V2X_STACK_BTP__MSG__DETAIL__UDP_DATA_IND_HDR__TRAITS_HPP_
