...
#ifndef V2X_STACK_BTP__MSG__DETAIL__TRAFFIC_CLASS__TRAITS_HPP_
#define V2X_STACK_BTP__MSG__DETAIL__TRAFFIC_CLASS__TRAITS_HPP_
...
inline void to_yaml(
  const v2x_stack_btp::msg::TrafficClass & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const v2x_stack_btp::msg::TrafficClass & msg)
{
  return v2x_stack_btp::msg::to_yaml(msg);
}

template<>
inline const char * data_type<v2x_stack_btp::msg::TrafficClass>()
{
  return "v2x_stack_btp::msg::TrafficClass";
}

template<>
inline const char * name<v2x_stack_btp::msg::TrafficClass>()
{
  return "v2x_stack_btp/msg/TrafficClass";
}

template<>
struct has_fixed_size<v2x_stack_btp::msg::TrafficClass>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<v2x_stack_btp::msg::TrafficClass>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<v2x_stack_btp::msg::TrafficClass>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // V2X_STACK_BTP__MSG__DETAIL__TRAFFIC_CLASS__TRAITS_HPP_
