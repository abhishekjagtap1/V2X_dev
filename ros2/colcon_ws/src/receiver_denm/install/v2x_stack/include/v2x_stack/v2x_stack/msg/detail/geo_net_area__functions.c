...
v2x_stack__msg__GeoNetArea__create(void)
{
  ...
  v2x_stack__msg__GeoNetArea * msg = (v2x_stack__msg__GeoNetArea *)allocator.allocate(sizeof(v2x_stack__msg__GeoNetArea), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(v2x_stack__msg__GeoNetArea));
  bool success = v2x_stack__msg__GeoNetArea__init(msg);
  if (!success) {
...
v2x_stack__msg__GeoNetArea__destroy(v2x_stack__msg__GeoNetArea * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    v2x_stack__msg__GeoNetArea__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
v2x_stack__msg__GeoNetArea__Sequence__init(v2x_stack__msg__GeoNetArea__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_stack__msg__GeoNetArea * data = NULL;

  if (size) {
    data = (v2x_stack__msg__GeoNetArea *)allocator.zero_allocate(size, sizeof(v2x_stack__msg__GeoNetArea), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = v2x_stack__msg__GeoNetArea__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        v2x_stack__msg__GeoNetArea__fini(&data[i - 1]);
      }
...
v2x_stack__msg__GeoNetArea__Sequence__fini(v2x_stack__msg__GeoNetArea__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      v2x_stack__msg__GeoNetArea__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  v2x_stack__msg__GeoNetArea__Sequence * array = (v2x_stack__msg__GeoNetArea__Sequence *)allocator.allocate(sizeof(v2x_stack__msg__GeoNetArea__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = v2x_stack__msg__GeoNetArea__Sequence__init(array, size);
  if (!success) {
...
v2x_stack__msg__GeoNetArea__Sequence__destroy(v2x_stack__msg__GeoNetArea__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    v2x_stack__msg__GeoNetArea__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
v2x_stack__msg__GeoNetArea__Sequence__are_equal(const v2x_stack__msg__GeoNetArea__Sequence * lhs, const v2x_stack__msg__GeoNetArea__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!v2x_stack__msg__GeoNetArea__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  v2x_stack__msg__GeoNetArea__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(v2x_stack__msg__GeoNetArea);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    v2x_stack__msg__GeoNetArea * data =
      (v2x_stack__msg__GeoNetArea *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!v2x_stack__msg__GeoNetArea__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          v2x_stack__msg__GeoNetArea__fini(&output->data[i]);
        }
        return false;
      }
    }
