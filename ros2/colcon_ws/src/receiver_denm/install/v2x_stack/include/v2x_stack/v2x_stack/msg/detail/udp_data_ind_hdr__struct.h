...
#ifndef V2X_STACK__MSG__DETAIL__UDP_DATA_IND_HDR__STRUCT_H_
#define V2X_STACK__MSG__DETAIL__UDP_DATA_IND_HDR__STRUCT_H_
...
/// Struct defined in msg/UDPDataIndHdr in the package v2x_stack.
/**
  * BTP Type
 */
typedef struct v2x_stack__msg__UDPDataIndHdr
{
  uint8_t btp_type;
  ...
  v2x_stack__msg__Location location;
  /// Area for GBC or GAC
  v2x_stack__msg__Area area;
  /// GN Security Type
  uint8_t sec_profile;
...
// Struct for a sequence of v2x_stack__msg__UDPDataIndHdr.
typedef struct v2x_stack__msg__UDPDataIndHdr__Sequence
{
...
#endif  // V2X_STACK__MSG__DETAIL__UDP_DATA_IND_HDR__STRUCT_H_
