...
#ifndef V2X_STACK__MSG__DETAIL__UDP_MSG_TYPE__FUNCTIONS_H_
#define V2X_STACK__MSG__DETAIL__UDP_MSG_TYPE__FUNCTIONS_H_
 ...
 * )) before or use
 * v2x_stack__msg__UDPMsgType__create()
 ...
 * calls
 * v2x_stack__msg__UDPMsgType__init().
...
/**
 * It calls
 * v2x_stack__msg__UDPMsgType__fini()
 ...
 * v2x_stack__msg__UDPMsgType__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * v2x_stack__msg__UDPMsgType__Sequence__fini()
 * on the array,
...
#endif  // V2X_STACK__MSG__DETAIL__UDP_MSG_TYPE__FUNCTIONS_H_
