...
{
  new (message_memory) v2x_stack::msg::Location(_init);
}

void Location_fini_function(void * message_memory)
{
  auto typed_message = static_cast<v2x_stack::msg::Location *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Location_message_member_array[3] = {
  {
    ...
    offsetof(v2x_stack::msg::Location, destination),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_stack::msg::Location, lat),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_stack::msg::Location, lon),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<v2x_stack::msg::Location>()
{
  return &::v2x_stack::msg::rosidl_typesupport_introspection_cpp::Location_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2x_stack, msg, Location)() {
  return &::v2x_stack::msg::rosidl_typesupport_introspection_cpp::Location_message_type_support_handle;
}
