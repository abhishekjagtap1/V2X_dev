...
#include "ros_etsi_its_msgs/msg/detail/altitude__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::Altitude;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::Altitude *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::Altitude *>(
    untyped_ros_message);
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_Altitude__handle;
}
