...
#include "ros_etsi_its_msgs/msg/detail/movement_event__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_etsi_its_msgs::msg::MovementEvent & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs::msg::MovementEvent & ros_message)
{
  // Member: event_state
  cdr >> ros_message.event_state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::MovementEvent;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::MovementEvent *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::MovementEvent *>(
    untyped_ros_message);
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_MovementEvent__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, MovementEvent)() {
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_MovementEvent__handle;
}
