...
#include "ros_etsi_its_msgs/msg/detail/mapem__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros_etsi_its_msgs::msg::Intersections &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ros_etsi_its_msgs::msg::Intersections &);
size_t get_serialized_size(
  const ros_etsi_its_msgs::msg::Intersections &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const ros_etsi_its_msgs::msg::MAPEM & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs::msg::MAPEM & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: intersections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Intersections(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::MAPEM;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: intersections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Intersections(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::MAPEM *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::MAPEM *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MAPEM__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::MAPEM *>(
...
static size_t _MAPEM__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MAPEM(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MAPEM__callbacks = {
...
static rosidl_message_type_support_t _MAPEM__handle = {
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_MAPEM__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, MAPEM)() {
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_MAPEM__handle;
}
