...
#include "ros_etsi_its_msgs/msg/detail/path_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs::msg::PathPoint & ros_message)
{
  // Member: path_position
  ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.path_position);

  // Member: path_delta_time
  ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.path_delta_time);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::PathPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::PathPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::PathPoint *>(
    untyped_ros_message);
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_PathPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, PathPoint)() {
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_PathPoint__handle;
}
