...
#include "ros_etsi_its_msgs/msg/detail/yaw_rate__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_etsi_its_msgs::msg::YawRate & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs::msg::YawRate & ros_message)
{
  // Member: value
  cdr >> ros_message.value;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::YawRate;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_etsi_its_msgs
max_serialized_size_key_YawRate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::YawRate *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::YawRate *>(
    untyped_ros_message);
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_YawRate__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, YawRate)() {
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_YawRate__handle;
}
