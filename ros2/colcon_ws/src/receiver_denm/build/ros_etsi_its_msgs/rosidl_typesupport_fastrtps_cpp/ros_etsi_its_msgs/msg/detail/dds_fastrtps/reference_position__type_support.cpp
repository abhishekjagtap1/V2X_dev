...
#include "ros_etsi_its_msgs/msg/detail/reference_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros_etsi_its_msgs::msg::PositionConfidenceEllipse &,
...
size_t
max_serialized_size_PositionConfidenceEllipse(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_PositionConfidenceEllipse(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
{
bool cdr_serialize(
  const ros_etsi_its_msgs::msg::Altitude &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_Altitude(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const ros_etsi_its_msgs::msg::ReferencePosition & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.position_confidence,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs::msg::ReferencePosition & ros_message)
{
  // Member: latitude
  cdr >> ros_message.latitude;
  ...
  size_t current_alignment)
{
  ...
  // Member: position_confidence
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PositionConfidenceEllipse(
  ...
  // Member: altitude
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Altitude(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::ReferencePosition;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: position_confidence
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_PositionConfidenceEllipse(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: altitude
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Altitude(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::ReferencePosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::ReferencePosition *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ReferencePosition__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::ReferencePosition *>(
...
static size_t _ReferencePosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ReferencePosition(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ReferencePosition__callbacks = {
...
static rosidl_message_type_support_t _ReferencePosition__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ReferencePosition__callbacks,
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_ReferencePosition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, ReferencePosition)() {
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_ReferencePosition__handle;
}
