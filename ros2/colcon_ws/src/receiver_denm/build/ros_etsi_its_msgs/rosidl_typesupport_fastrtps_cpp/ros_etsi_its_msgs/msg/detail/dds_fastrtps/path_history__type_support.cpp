...
#include "ros_etsi_its_msgs/msg/detail/path_history__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros_etsi_its_msgs::msg::PathPoint &,
...
cdr_serialize(
  const ros_etsi_its_msgs::msg::PathHistory & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs::msg::PathHistory & ros_message)
{
  // Member: points
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PathPoint(
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::PathHistory;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_PathPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::PathHistory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::PathHistory *>(
    untyped_ros_message);
...
static size_t _PathHistory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PathHistory(full_bounded, is_plain, 0);
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_PathHistory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, PathHistory)() {
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_PathHistory__handle;
}
