...
#include "ros_etsi_its_msgs/msg/detail/sensor_information_container__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros_etsi_its_msgs::msg::SensorInformation &,
...
cdr_serialize(
  const ros_etsi_its_msgs::msg::SensorInformationContainer & ros_message,
  ...
  // Member: sensors_information
  {
    ...
    for (size_t i = 0; i < size; i++) {
      ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.sensors_information[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs::msg::SensorInformationContainer & ros_message)
{
  // Member: sensors_information
  {
    uint32_t cdrSize;
    ...
    ros_message.sensors_information.resize(size);
    for (size_t i = 0; i < size; i++) {
      ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.sensors_information[i]);
    }
  }
  ...
  // Member: sensors_information
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.sensors_information[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_etsi_its_msgs
max_serialized_size_SensorInformationContainer(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: sensors_information
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_SensorInformation(
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::SensorInformationContainer;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_etsi_its_msgs
max_serialized_size_key_SensorInformationContainer(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: sensors_information
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_SensorInformation(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::SensorInformationContainer *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::SensorInformationContainer *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SensorInformationContainer__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::SensorInformationContainer *>(
...
static size_t _SensorInformationContainer__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SensorInformationContainer(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SensorInformationContainer__callbacks = {
...
static rosidl_message_type_support_t _SensorInformationContainer__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SensorInformationContainer__callbacks,
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_SensorInformationContainer__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, SensorInformationContainer)() {
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_SensorInformationContainer__handle;
}
