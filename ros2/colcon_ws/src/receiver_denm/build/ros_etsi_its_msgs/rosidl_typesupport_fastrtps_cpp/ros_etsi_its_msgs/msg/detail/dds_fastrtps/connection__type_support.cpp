...
#include "ros_etsi_its_msgs/msg/detail/connection__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::Connection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::Connection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::Connection *>(
    untyped_ros_message);
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_Connection__handle;
}
