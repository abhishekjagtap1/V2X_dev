...
#include "ros_etsi_its_msgs/msg/detail/curvature__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_etsi_its_msgs::msg::Curvature & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs::msg::Curvature & ros_message)
{
  // Member: value
  cdr >> ros_message.value;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::Curvature;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_etsi_its_msgs
max_serialized_size_key_Curvature(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::Curvature *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::Curvature *>(
    untyped_ros_message);
...
static size_t _Curvature__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Curvature(full_bounded, is_plain, 0);
...
get_message_type_support_handle<ros_etsi_its_msgs::msg::Curvature>()
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_Curvature__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, Curvature)() {
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_Curvature__handle;
}
