...
#include "ros_etsi_its_msgs/msg/detail/movement_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros_etsi_its_msgs::msg::MovementEvent &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ros_etsi_its_msgs::msg::MovementEvent &);
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_MovementEvent(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const ros_etsi_its_msgs::msg::MovementState & ros_message,
  ...
  // Member: state_time_speed
  {
    ...
    for (size_t i = 0; i < size; i++) {
      ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.state_time_speed[i],
        cdr);
    }
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs::msg::MovementState & ros_message)
{
  // Member: signal_group
  cdr >> ros_message.signal_group;
  ...
  // Member: state_time_speed
  {
    ...
    ros_message.state_time_speed.resize(size);
    for (size_t i = 0; i < size; i++) {
      ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.state_time_speed[i]);
    }
  }
  ...
  // Member: state_time_speed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.state_time_speed[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: state_time_speed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MovementEvent(
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::MovementState;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_etsi_its_msgs
max_serialized_size_key_MovementState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: state_time_speed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_MovementEvent(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::MovementState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::MovementState *>(
    untyped_ros_message);
...
static size_t _MovementState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MovementState(full_bounded, is_plain, 0);
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_MovementState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, MovementState)() {
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_MovementState__handle;
}
