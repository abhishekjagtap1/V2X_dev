...
#include "ros_etsi_its_msgs/msg/detail/location_container__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros_etsi_its_msgs::msg::Speed &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ros_etsi_its_msgs::msg::Speed &);
...
{
bool cdr_serialize(
  const ros_etsi_its_msgs::msg::Heading &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ros_etsi_its_msgs::msg::Heading &);
size_t get_serialized_size(
  const ros_etsi_its_msgs::msg::Heading &,
  size_t current_alignment);
size_t
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_Heading(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const ros_etsi_its_msgs::msg::LocationContainer & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: event_speed
  ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.event_speed,
    cdr);

  // Member: event_position_heading
  ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.event_position_heading,
    cdr);
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs::msg::LocationContainer & ros_message)
{
  // Member: event_speed
  ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.event_speed);

  // Member: event_position_heading
  ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.event_position_heading);
  ...
  // Member: traces
  {
    ...
    ros_message.traces.resize(size);
    for (size_t i = 0; i < size; i++) {
      ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.traces[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: traces
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.traces[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_etsi_its_msgs
max_serialized_size_LocationContainer(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: event_speed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Speed(
  ...
  // Member: event_position_heading
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Heading(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::LocationContainer;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_etsi_its_msgs
max_serialized_size_key_LocationContainer(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: event_speed
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Speed(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: event_position_heading
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Heading(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::LocationContainer *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::LocationContainer *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LocationContainer__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::LocationContainer *>(
...
static size_t _LocationContainer__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LocationContainer(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LocationContainer__callbacks = {
...
static rosidl_message_type_support_t _LocationContainer__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LocationContainer__callbacks,
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_LocationContainer__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, LocationContainer)() {
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_LocationContainer__handle;
}
