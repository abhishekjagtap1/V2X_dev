...
#include "ros_etsi_its_msgs/msg/detail/intersection_geometry__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ros_etsi_its_msgs::msg::GenericLane &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const ros_etsi_its_msgs::msg::IntersectionGeometry & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs::msg::IntersectionGeometry & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  // Member: lane_set
  {
    ...
    ros_message.lane_set.resize(size);
    for (size_t i = 0; i < size; i++) {
      ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.lane_set[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: lane_set
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.lane_set[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: lane_set
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_GenericLane(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs::msg::IntersectionGeometry;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_etsi_its_msgs
max_serialized_size_key_IntersectionGeometry(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: lane_set
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_GenericLane(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::IntersectionGeometry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_etsi_its_msgs::msg::IntersectionGeometry *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IntersectionGeometry__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros_etsi_its_msgs::msg::IntersectionGeometry *>(
...
static size_t _IntersectionGeometry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_IntersectionGeometry(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _IntersectionGeometry__callbacks = {
...
static rosidl_message_type_support_t _IntersectionGeometry__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IntersectionGeometry__callbacks,
...
{
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_IntersectionGeometry__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, IntersectionGeometry)() {
  return &ros_etsi_its_msgs::msg::typesupport_fastrtps_cpp::_IntersectionGeometry__handle;
}
