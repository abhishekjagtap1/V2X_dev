...
static const _PositionConfidenceEllipse_type_support_symbol_names_t _PositionConfidenceEllipse_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_etsi_its_msgs, msg, PositionConfidenceEllipse)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_etsi_its_msgs, msg, PositionConfidenceEllipse)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_etsi_its_msgs, msg, PositionConfidenceEllipse)() {
  return &::ros_etsi_its_msgs::msg::rosidl_typesupport_c::PositionConfidenceEllipse_message_type_support_handle;
}
