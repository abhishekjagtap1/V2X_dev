...
static const _PerceivedObject_type_support_symbol_names_t _PerceivedObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_etsi_its_msgs, msg, PerceivedObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_etsi_its_msgs, msg, PerceivedObject)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_etsi_its_msgs, msg, PerceivedObject)() {
  return &::ros_etsi_its_msgs::msg::rosidl_typesupport_c::PerceivedObject_message_type_support_handle;
}
