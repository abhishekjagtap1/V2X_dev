...
bool ros_etsi_its_msgs__msg__wgs84_angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_etsi_its_msgs.msg._wgs84_angle.WGS84Angle", full_classname_dest, 45) == 0);
  }
  ros_etsi_its_msgs__msg__WGS84Angle * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of WGS84Angle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_etsi_its_msgs.msg._wgs84_angle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WGS84Angle");
