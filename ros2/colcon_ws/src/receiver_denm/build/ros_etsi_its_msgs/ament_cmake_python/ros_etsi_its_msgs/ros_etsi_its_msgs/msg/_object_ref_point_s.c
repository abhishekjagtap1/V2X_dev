...
bool ros_etsi_its_msgs__msg__object_ref_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_etsi_its_msgs.msg._object_ref_point.ObjectRefPoint", full_classname_dest, 54) == 0);
  }
  ros_etsi_its_msgs__msg__ObjectRefPoint * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of ObjectRefPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_etsi_its_msgs.msg._object_ref_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjectRefPoint");
