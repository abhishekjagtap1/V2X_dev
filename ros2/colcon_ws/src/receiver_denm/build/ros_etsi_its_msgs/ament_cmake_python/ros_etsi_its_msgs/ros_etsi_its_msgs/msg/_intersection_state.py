...
class Metaclass_IntersectionState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros_etsi_its_msgs.msg import MovementState
...
class IntersectionState(metaclass=Metaclass_IntersectionState):
    ...
    _fields_and_field_types = {
        ...
        'revision': 'uint8',
        'status': 'uint16',
        'states': 'sequence<ros_etsi_its_msgs/MovementState>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint16'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros_etsi_its_msgs', 'msg'], 'MovementState')),  # noqa: E501
    )
