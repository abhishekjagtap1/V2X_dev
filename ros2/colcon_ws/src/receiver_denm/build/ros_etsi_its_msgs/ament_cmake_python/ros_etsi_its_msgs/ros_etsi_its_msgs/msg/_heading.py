...
class Metaclass_Heading(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            'VALUE_NORTH': cls.__constants['VALUE_NORTH'],
            'VALUE_EAST': cls.__constants['VALUE_EAST'],
            'VALUE_SOUTH': cls.__constants['VALUE_SOUTH'],
            'VALUE_WEST': cls.__constants['VALUE_WEST'],
    ...
    @property
    def VALUE_NORTH(self):
        """Message constant 'VALUE_NORTH'."""
        return Metaclass_Heading.__constants['VALUE_NORTH']

    @property
    def VALUE_EAST(self):
        """Message constant 'VALUE_EAST'."""
        return Metaclass_Heading.__constants['VALUE_EAST']

    @property
    def VALUE_SOUTH(self):
        """Message constant 'VALUE_SOUTH'."""
        return Metaclass_Heading.__constants['VALUE_SOUTH']

    @property
    def VALUE_WEST(self):
        """Message constant 'VALUE_WEST'."""
        return Metaclass_Heading.__constants['VALUE_WEST']

    @property
    def VALUE_UNAVAILABLE(self):
        """Message constant 'VALUE_UNAVAILABLE'."""
        return Metaclass_Heading.__constants['VALUE_UNAVAILABLE']

    @property
    def CONFIDENCE_ZERO_POINT_ONE_DEGREE(self):
        """Message constant 'CONFIDENCE_ZERO_POINT_ONE_DEGREE'."""
        return Metaclass_Heading.__constants['CONFIDENCE_ZERO_POINT_ONE_DEGREE']

    @property
    def CONFIDENCE_ONE_DEGREE(self):
        """Message constant 'CONFIDENCE_ONE_DEGREE'."""
        return Metaclass_Heading.__constants['CONFIDENCE_ONE_DEGREE']

    @property
    def CONFIDENCE_OUT_OF_RANGE(self):
        """Message constant 'CONFIDENCE_OUT_OF_RANGE'."""
        return Metaclass_Heading.__constants['CONFIDENCE_OUT_OF_RANGE']

    @property
    def CONFIDENCE_UNAVAILABLE(self):
        """Message constant 'CONFIDENCE_UNAVAILABLE'."""
        return Metaclass_Heading.__constants['CONFIDENCE_UNAVAILABLE']
