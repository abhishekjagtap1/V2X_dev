...
bool ros_etsi_its_msgs__msg__curvature__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * ros_etsi_its_msgs__msg__curvature__convert_to_py(void * raw_ros_message);
bool ros_etsi_its_msgs__msg__curvature_calculation_mode__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool ros_etsi_its_msgs__msg__acceleration_control__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool ros_etsi_its_msgs__msg__basic_vehicle_container_high_frequency__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_etsi_its_msgs.msg._basic_vehicle_container_high_frequency.BasicVehicleContainerHighFrequency", full_classname_dest, 96) == 0);
  }
  ros_etsi_its_msgs__msg__BasicVehicleContainerHighFrequency * ros_message = _ros_message;
  {  // heading
  ...
  {  // curvature
    ...
    if (!ros_etsi_its_msgs__msg__curvature__convert_from_py(field, &ros_message->curvature)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // curvature_calculation_mode
    PyObject * field = PyObject_GetAttrString(_pymsg, "curvature_calculation_mode");
    if (!field) {
      return false;
    }
    if (!ros_etsi_its_msgs__msg__curvature_calculation_mode__convert_from_py(field, &ros_message->curvature_calculation_mode)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // has_acceleration_control
    PyObject * field = PyObject_GetAttrString(_pymsg, "has_acceleration_control");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->has_acceleration_control = (Py_True == field);
    Py_DECREF(field);
  }
  {  // acceleration_control
    PyObject * field = PyObject_GetAttrString(_pymsg, "acceleration_control");
    if (!field) {
      return false;
    }
    if (!ros_etsi_its_msgs__msg__acceleration_control__convert_from_py(field, &ros_message->acceleration_control)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of BasicVehicleContainerHighFrequency */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_etsi_its_msgs.msg._basic_vehicle_container_high_frequency");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BasicVehicleContainerHighFrequency");
  ...
  {  // curvature
    PyObject * field = NULL;
    field = ros_etsi_its_msgs__msg__curvature__convert_to_py(&ros_message->curvature);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // curvature_calculation_mode
    PyObject * field = NULL;
    field = ros_etsi_its_msgs__msg__curvature_calculation_mode__convert_to_py(&ros_message->curvature_calculation_mode);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "curvature_calculation_mode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // has_acceleration_control
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->has_acceleration_control ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "has_acceleration_control", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // acceleration_control
    PyObject * field = NULL;
    field = ros_etsi_its_msgs__msg__acceleration_control__convert_to_py(&ros_message->acceleration_control);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "acceleration_control", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
