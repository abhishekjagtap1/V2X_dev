...
bool ros_etsi_its_msgs__msg__matched_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_etsi_its_msgs.msg._matched_position.MatchedPosition", full_classname_dest, 55) == 0);
  }
  ros_etsi_its_msgs__msg__MatchedPosition * ros_message = _ros_message;
  {  // lane_id
...
{
  /* NOTE(esteve): Call constructor of MatchedPosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_etsi_its_msgs.msg._matched_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MatchedPosition");
