...
bool ros_etsi_its_msgs__msg__exterior_lights__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_etsi_its_msgs.msg._exterior_lights.ExteriorLights", full_classname_dest, 53) == 0);
  }
  ros_etsi_its_msgs__msg__ExteriorLights * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of ExteriorLights */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_etsi_its_msgs.msg._exterior_lights");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExteriorLights");
