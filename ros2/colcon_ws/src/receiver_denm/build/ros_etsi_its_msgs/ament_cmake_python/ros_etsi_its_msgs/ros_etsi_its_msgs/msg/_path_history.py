...
class Metaclass_PathHistory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros_etsi_its_msgs.msg import PathPoint
...
class PathHistory(metaclass=Metaclass_PathHistory):
    ...
    _fields_and_field_types = {
        'points': 'sequence<ros_etsi_its_msgs/PathPoint>',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros_etsi_its_msgs', 'msg'], 'PathPoint')),  # noqa: E501
    )
