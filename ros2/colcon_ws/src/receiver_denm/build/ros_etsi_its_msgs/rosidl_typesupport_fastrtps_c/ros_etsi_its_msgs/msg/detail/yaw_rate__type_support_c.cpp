...
#include "ros_etsi_its_msgs/msg/detail/yaw_rate__rosidl_typesupport_fastrtps_c.h"
...
using _YawRate__ros_msg_type = ros_etsi_its_msgs__msg__YawRate;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__YawRate;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__YawRate * ros_message = static_cast<const ros_etsi_its_msgs__msg__YawRate *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__YawRate(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__YawRate * ros_message = static_cast<ros_etsi_its_msgs__msg__YawRate *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__YawRate(cdr, ros_message);
}

static uint32_t _YawRate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__YawRate(
...
static size_t _YawRate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__YawRate(
