...
#include "ros_etsi_its_msgs/msg/detail/heading__rosidl_typesupport_fastrtps_c.h"
...
using _Heading__ros_msg_type = ros_etsi_its_msgs__msg__Heading;
...
{
  const _Heading__ros_msg_type * ros_message = static_cast<const _Heading__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__Heading;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__Heading * ros_message = static_cast<const ros_etsi_its_msgs__msg__Heading *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__Heading(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__Heading * ros_message = static_cast<ros_etsi_its_msgs__msg__Heading *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__Heading(cdr, ros_message);
}

static uint32_t _Heading__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__Heading(
...
static size_t _Heading__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__Heading(
...
static message_type_support_callbacks_t __callbacks_Heading = {
...
static rosidl_message_type_support_t _Heading__type_support = {
