...
#include "ros_etsi_its_msgs/msg/detail/originating_vehicle_container__rosidl_typesupport_fastrtps_c.h"
...
#include "ros_etsi_its_msgs/msg/detail/wgs84_angle__functions.h"  // vehicle_orientation_angle
...
using _OriginatingVehicleContainer__ros_msg_type = ros_etsi_its_msgs__msg__OriginatingVehicleContainer;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: has_vehicle_orientation_angle
  {
    cdr << (ros_message->has_vehicle_orientation_angle ? true : false);
  }

  // Field name: vehicle_orientation_angle
  {
    cdr_serialize_ros_etsi_its_msgs__msg__WGS84Angle(
      &ros_message->vehicle_orientation_angle, cdr);
  }
  ...
  // Field name: has_vehicle_length
  {
    cdr << (ros_message->has_vehicle_length ? true : false);
  }
  ...
  // Field name: has_vehicle_width
  {
    cdr << (ros_message->has_vehicle_width ? true : false);
  }
  ...
  // Field name: has_vehicle_height
  {
    cdr << (ros_message->has_vehicle_height ? true : false);
  }
  ...
  // Field name: has_longitudinal_acceleration
  {
    cdr << (ros_message->has_longitudinal_acceleration ? true : false);
  }
  ...
  // Field name: has_yaw_rate
  {
    cdr << (ros_message->has_yaw_rate ? true : false);
  }
  ...
  ros_etsi_its_msgs__msg__OriginatingVehicleContainer * ros_message)
{
  ...
  // Field name: has_vehicle_orientation_angle
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->has_vehicle_orientation_angle = tmp ? true : false;
  }

  // Field name: vehicle_orientation_angle
  {
    cdr_deserialize_ros_etsi_its_msgs__msg__WGS84Angle(cdr, &ros_message->vehicle_orientation_angle);
  }
  ...
  // Field name: has_vehicle_length
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->has_vehicle_length = tmp ? true : false;
  }
  ...
  // Field name: has_vehicle_width
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->has_vehicle_width = tmp ? true : false;
  }
  ...
  // Field name: has_vehicle_height
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->has_vehicle_height = tmp ? true : false;
  }
  ...
  // Field name: has_longitudinal_acceleration
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->has_longitudinal_acceleration = tmp ? true : false;
  }
  ...
  // Field name: has_yaw_rate
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->has_yaw_rate = tmp ? true : false;
  }
...
size_t get_serialized_size_ros_etsi_its_msgs__msg__OriginatingVehicleContainer(
  ...
  size_t current_alignment)
{
  const _OriginatingVehicleContainer__ros_msg_type * ros_message = static_cast<const _OriginatingVehicleContainer__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: has_vehicle_orientation_angle
  {
    size_t item_size = sizeof(ros_message->has_vehicle_orientation_angle);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }

  // Field name: vehicle_orientation_angle
  current_alignment += get_serialized_size_ros_etsi_its_msgs__msg__WGS84Angle(
    &(ros_message->vehicle_orientation_angle), current_alignment);
  ...
  // Field name: has_vehicle_length
  {
    size_t item_size = sizeof(ros_message->has_vehicle_length);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Field name: has_vehicle_width
  {
    size_t item_size = sizeof(ros_message->has_vehicle_width);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Field name: has_vehicle_height
  {
    size_t item_size = sizeof(ros_message->has_vehicle_height);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Field name: has_longitudinal_acceleration
  {
    size_t item_size = sizeof(ros_message->has_longitudinal_acceleration);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Field name: has_yaw_rate
  {
    size_t item_size = sizeof(ros_message->has_yaw_rate);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: vehicle_orientation_angle
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros_etsi_its_msgs__msg__WGS84Angle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__OriginatingVehicleContainer;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: vehicle_orientation_angle
  {
    cdr_serialize_key_ros_etsi_its_msgs__msg__WGS84Angle(
      &ros_message->vehicle_orientation_angle, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: vehicle_orientation_angle
  current_alignment += get_serialized_size_key_ros_etsi_its_msgs__msg__WGS84Angle(
    &(ros_message->vehicle_orientation_angle), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: vehicle_orientation_angle
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros_etsi_its_msgs__msg__WGS84Angle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _OriginatingVehicleContainer__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__OriginatingVehicleContainer * ros_message = static_cast<const ros_etsi_its_msgs__msg__OriginatingVehicleContainer *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__OriginatingVehicleContainer(ros_message, cdr);
}

static bool _OriginatingVehicleContainer__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__OriginatingVehicleContainer * ros_message = static_cast<ros_etsi_its_msgs__msg__OriginatingVehicleContainer *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__OriginatingVehicleContainer(cdr, ros_message);
}

static uint32_t _OriginatingVehicleContainer__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__OriginatingVehicleContainer(
      untyped_ros_message, 0));
}

static size_t _OriginatingVehicleContainer__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__OriginatingVehicleContainer(
...
static message_type_support_callbacks_t __callbacks_OriginatingVehicleContainer = {
  "ros_etsi_its_msgs::msg",
  "OriginatingVehicleContainer",
  _OriginatingVehicleContainer__cdr_serialize,
  _OriginatingVehicleContainer__cdr_deserialize,
  _OriginatingVehicleContainer__get_serialized_size,
  _OriginatingVehicleContainer__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _OriginatingVehicleContainer__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_OriginatingVehicleContainer,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_etsi_its_msgs, msg, OriginatingVehicleContainer)() {
  return &_OriginatingVehicleContainer__type_support;
}
