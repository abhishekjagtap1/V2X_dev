...
#include "ros_etsi_its_msgs/msg/detail/intersection_state__rosidl_typesupport_fastrtps_c.h"
...
#include "ros_etsi_its_msgs/msg/detail/movement_state__functions.h"  // states
...
using _IntersectionState__ros_msg_type = ros_etsi_its_msgs__msg__IntersectionState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: states
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ros_etsi_its_msgs__msg__MovementState(
        &array_ptr[i], cdr);
    }
  }
  ...
  ros_etsi_its_msgs__msg__IntersectionState * ros_message)
{
  ...
  // Field name: states
  {
    ...
    if (ros_message->states.data) {
      ros_etsi_its_msgs__msg__MovementState__Sequence__fini(&ros_message->states);
    }
    if (!ros_etsi_its_msgs__msg__MovementState__Sequence__init(&ros_message->states, size)) {
      fprintf(stderr, "failed to create array for field 'states'");
      return false;
    }
    auto array_ptr = ros_message->states.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ros_etsi_its_msgs__msg__MovementState(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros_etsi_its_msgs__msg__MovementState(
  ...
  size_t current_alignment)
{
  ...
  // Field name: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros_etsi_its_msgs__msg__MovementState(
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__IntersectionState;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: states
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ros_etsi_its_msgs__msg__MovementState(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: states
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ros_etsi_its_msgs__msg__MovementState(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros_etsi_its_msgs__msg__MovementState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__IntersectionState * ros_message = static_cast<const ros_etsi_its_msgs__msg__IntersectionState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__IntersectionState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__IntersectionState * ros_message = static_cast<ros_etsi_its_msgs__msg__IntersectionState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__IntersectionState(cdr, ros_message);
}

static uint32_t _IntersectionState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__IntersectionState(
...
static size_t _IntersectionState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__IntersectionState(
