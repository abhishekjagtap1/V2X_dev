...
#include "ros_etsi_its_msgs/msg/detail/mapem__rosidl_typesupport_fastrtps_c.h"
...
#include "ros_etsi_its_msgs/msg/detail/intersections__functions.h"  // intersections
...
using _MAPEM__ros_msg_type = ros_etsi_its_msgs__msg__MAPEM;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_etsi_its_msgs
bool cdr_serialize_ros_etsi_its_msgs__msg__MAPEM(
  const ros_etsi_its_msgs__msg__MAPEM * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  {
    cdr_serialize_ros_etsi_its_msgs__msg__Intersections(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_etsi_its_msgs
bool cdr_deserialize_ros_etsi_its_msgs__msg__MAPEM(
  eprosima::fastcdr::Cdr & cdr,
  ros_etsi_its_msgs__msg__MAPEM * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: intersections
  {
    cdr_deserialize_ros_etsi_its_msgs__msg__Intersections(cdr, &ros_message->intersections);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_etsi_its_msgs
size_t get_serialized_size_ros_etsi_its_msgs__msg__MAPEM(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MAPEM__ros_msg_type * ros_message = static_cast<const _MAPEM__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: intersections
  current_alignment += get_serialized_size_ros_etsi_its_msgs__msg__Intersections(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_etsi_its_msgs
size_t max_serialized_size_ros_etsi_its_msgs__msg__MAPEM(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: intersections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros_etsi_its_msgs__msg__Intersections(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__MAPEM;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_etsi_its_msgs
bool cdr_serialize_key_ros_etsi_its_msgs__msg__MAPEM(
  const ros_etsi_its_msgs__msg__MAPEM * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: intersections
  {
    cdr_serialize_key_ros_etsi_its_msgs__msg__Intersections(
      &ros_message->intersections, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_etsi_its_msgs
size_t get_serialized_size_key_ros_etsi_its_msgs__msg__MAPEM(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MAPEM__ros_msg_type * ros_message = static_cast<const _MAPEM__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: intersections
  current_alignment += get_serialized_size_key_ros_etsi_its_msgs__msg__Intersections(
    &(ros_message->intersections), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_etsi_its_msgs
size_t max_serialized_size_key_ros_etsi_its_msgs__msg__MAPEM(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: intersections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros_etsi_its_msgs__msg__Intersections(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _MAPEM__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__MAPEM * ros_message = static_cast<const ros_etsi_its_msgs__msg__MAPEM *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__MAPEM(ros_message, cdr);
}

static bool _MAPEM__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__MAPEM * ros_message = static_cast<ros_etsi_its_msgs__msg__MAPEM *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__MAPEM(cdr, ros_message);
}

static uint32_t _MAPEM__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__MAPEM(
      untyped_ros_message, 0));
}

static size_t _MAPEM__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__MAPEM(
...
static message_type_support_callbacks_t __callbacks_MAPEM = {
  "ros_etsi_its_msgs::msg",
  "MAPEM",
  _MAPEM__cdr_serialize,
  _MAPEM__cdr_deserialize,
  _MAPEM__get_serialized_size,
  _MAPEM__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _MAPEM__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_etsi_its_msgs, msg, MAPEM)() {
  return &_MAPEM__type_support;
}
