...
#include "ros_etsi_its_msgs/msg/detail/intersection_geometry__rosidl_typesupport_fastrtps_c.h"
...
#include "ros_etsi_its_msgs/msg/detail/generic_lane__functions.h"  // lane_set
#include "ros_etsi_its_msgs/msg/detail/reference_position__functions.h"  // ref_point
...
using _IntersectionGeometry__ros_msg_type = ros_etsi_its_msgs__msg__IntersectionGeometry;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: lane_set
  {
    ...
    auto array_ptr = ros_message->lane_set.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ros_etsi_its_msgs__msg__GenericLane(
        &array_ptr[i], cdr);
    }
  }
  ...
  ros_etsi_its_msgs__msg__IntersectionGeometry * ros_message)
{
  ...
  // Field name: ref_point
  {
    cdr_deserialize_ros_etsi_its_msgs__msg__ReferencePosition(cdr, &ros_message->ref_point);
  }
  ...
  // Field name: lane_set
  {
    ...
    if (ros_message->lane_set.data) {
      ros_etsi_its_msgs__msg__GenericLane__Sequence__fini(&ros_message->lane_set);
    }
    if (!ros_etsi_its_msgs__msg__GenericLane__Sequence__init(&ros_message->lane_set, size)) {
      fprintf(stderr, "failed to create array for field 'lane_set'");
      return false;
    }
    auto array_ptr = ros_message->lane_set.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ros_etsi_its_msgs__msg__GenericLane(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: lane_set
  {
    size_t array_size = ros_message->lane_set.size;
    auto array_ptr = ros_message->lane_set.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros_etsi_its_msgs__msg__GenericLane(
  ...
  size_t current_alignment)
{
  ...
  // Field name: lane_set
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros_etsi_its_msgs__msg__GenericLane(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__IntersectionGeometry;
    is_plain =
      (
      offsetof(DataType, lane_set) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: lane_set
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ros_etsi_its_msgs__msg__GenericLane(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: lane_set
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ros_etsi_its_msgs__msg__GenericLane(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: lane_set
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros_etsi_its_msgs__msg__GenericLane(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__IntersectionGeometry * ros_message = static_cast<const ros_etsi_its_msgs__msg__IntersectionGeometry *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__IntersectionGeometry(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__IntersectionGeometry * ros_message = static_cast<ros_etsi_its_msgs__msg__IntersectionGeometry *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__IntersectionGeometry(cdr, ros_message);
}

static uint32_t _IntersectionGeometry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__IntersectionGeometry(
...
static size_t _IntersectionGeometry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__IntersectionGeometry(
