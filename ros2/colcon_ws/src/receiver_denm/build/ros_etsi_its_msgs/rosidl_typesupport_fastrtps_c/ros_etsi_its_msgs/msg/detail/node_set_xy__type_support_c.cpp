...
#include "ros_etsi_its_msgs/msg/detail/node_set_xy__rosidl_typesupport_fastrtps_c.h"
...
#include "ros_etsi_its_msgs/msg/detail/reference_position__functions.h"  // pos
...
using _NodeSetXY__ros_msg_type = ros_etsi_its_msgs__msg__NodeSetXY;
  ...
  ros_etsi_its_msgs__msg__NodeSetXY * ros_message)
{
  ...
  // Field name: pos
  {
    cdr_deserialize_ros_etsi_its_msgs__msg__ReferencePosition(cdr, &ros_message->pos);
  }
...
size_t get_serialized_size_ros_etsi_its_msgs__msg__NodeSetXY(
  ...
  size_t current_alignment)
{
  const _NodeSetXY__ros_msg_type * ros_message = static_cast<const _NodeSetXY__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__NodeSetXY;
    is_plain =
      (
...
static bool _NodeSetXY__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__NodeSetXY * ros_message = static_cast<const ros_etsi_its_msgs__msg__NodeSetXY *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__NodeSetXY(ros_message, cdr);
}

static bool _NodeSetXY__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__NodeSetXY * ros_message = static_cast<ros_etsi_its_msgs__msg__NodeSetXY *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__NodeSetXY(cdr, ros_message);
}

static uint32_t _NodeSetXY__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__NodeSetXY(
      untyped_ros_message, 0));
}

static size_t _NodeSetXY__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__NodeSetXY(
...
static message_type_support_callbacks_t __callbacks_NodeSetXY = {
  "ros_etsi_its_msgs::msg",
  "NodeSetXY",
  _NodeSetXY__cdr_serialize,
  _NodeSetXY__cdr_deserialize,
  _NodeSetXY__get_serialized_size,
  _NodeSetXY__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _NodeSetXY__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_NodeSetXY,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_etsi_its_msgs, msg, NodeSetXY)() {
  return &_NodeSetXY__type_support;
}
