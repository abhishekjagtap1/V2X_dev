...
#include "ros_etsi_its_msgs/msg/detail/path_history__rosidl_typesupport_fastrtps_c.h"
...
#include "ros_etsi_its_msgs/msg/detail/path_point__functions.h"  // points
...
using _PathHistory__ros_msg_type = ros_etsi_its_msgs__msg__PathHistory;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: points
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ros_etsi_its_msgs__msg__PathPoint(
        &array_ptr[i], cdr);
    }
  }
  ...
  ros_etsi_its_msgs__msg__PathHistory * ros_message)
{
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      ros_etsi_its_msgs__msg__PathPoint__Sequence__fini(&ros_message->points);
    }
    if (!ros_etsi_its_msgs__msg__PathPoint__Sequence__init(&ros_message->points, size)) {
      fprintf(stderr, "failed to create array for field 'points'");
      return false;
    }
    auto array_ptr = ros_message->points.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ros_etsi_its_msgs__msg__PathPoint(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros_etsi_its_msgs__msg__PathPoint(
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros_etsi_its_msgs__msg__PathPoint(
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__PathHistory;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: points
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ros_etsi_its_msgs__msg__PathPoint(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ros_etsi_its_msgs__msg__PathPoint(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros_etsi_its_msgs__msg__PathPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__PathHistory * ros_message = static_cast<const ros_etsi_its_msgs__msg__PathHistory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__PathHistory(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__PathHistory * ros_message = static_cast<ros_etsi_its_msgs__msg__PathHistory *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__PathHistory(cdr, ros_message);
}

static uint32_t _PathHistory__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__PathHistory(
...
static size_t _PathHistory__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__PathHistory(
