...
#include "ros_etsi_its_msgs/msg/detail/its_pdu_header__rosidl_typesupport_fastrtps_c.h"
...
using _ItsPduHeader__ros_msg_type = ros_etsi_its_msgs__msg__ItsPduHeader;
...
{
  const _ItsPduHeader__ros_msg_type * ros_message = static_cast<const _ItsPduHeader__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__ItsPduHeader;
    is_plain =
      (
...
static bool _ItsPduHeader__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__ItsPduHeader * ros_message = static_cast<const ros_etsi_its_msgs__msg__ItsPduHeader *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__ItsPduHeader(ros_message, cdr);
}

static bool _ItsPduHeader__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__ItsPduHeader * ros_message = static_cast<ros_etsi_its_msgs__msg__ItsPduHeader *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__ItsPduHeader(cdr, ros_message);
}

static uint32_t _ItsPduHeader__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__ItsPduHeader(
      untyped_ros_message, 0));
}

static size_t _ItsPduHeader__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__ItsPduHeader(
...
static message_type_support_callbacks_t __callbacks_ItsPduHeader = {
  "ros_etsi_its_msgs::msg",
  "ItsPduHeader",
  _ItsPduHeader__cdr_serialize,
  _ItsPduHeader__cdr_deserialize,
  _ItsPduHeader__get_serialized_size,
  _ItsPduHeader__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _ItsPduHeader__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ItsPduHeader,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_etsi_its_msgs, msg, ItsPduHeader)() {
  return &_ItsPduHeader__type_support;
}
