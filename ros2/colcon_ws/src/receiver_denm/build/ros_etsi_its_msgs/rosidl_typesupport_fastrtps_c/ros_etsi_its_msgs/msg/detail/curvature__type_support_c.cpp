...
#include "ros_etsi_its_msgs/msg/detail/curvature__rosidl_typesupport_fastrtps_c.h"
...
using _Curvature__ros_msg_type = ros_etsi_its_msgs__msg__Curvature;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__Curvature;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__Curvature * ros_message = static_cast<const ros_etsi_its_msgs__msg__Curvature *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__Curvature(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__Curvature * ros_message = static_cast<ros_etsi_its_msgs__msg__Curvature *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__Curvature(cdr, ros_message);
}

static uint32_t _Curvature__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__Curvature(
      untyped_ros_message, 0));
}

static size_t _Curvature__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__Curvature(
