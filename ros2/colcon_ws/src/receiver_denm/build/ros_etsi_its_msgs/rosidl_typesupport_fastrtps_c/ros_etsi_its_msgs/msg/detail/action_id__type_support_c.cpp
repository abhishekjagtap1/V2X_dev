...
#include "ros_etsi_its_msgs/msg/detail/action_id__rosidl_typesupport_fastrtps_c.h"
...
using _ActionID__ros_msg_type = ros_etsi_its_msgs__msg__ActionID;
...
{
  const _ActionID__ros_msg_type * ros_message = static_cast<const _ActionID__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__ActionID;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__ActionID * ros_message = static_cast<const ros_etsi_its_msgs__msg__ActionID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__ActionID(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__ActionID * ros_message = static_cast<ros_etsi_its_msgs__msg__ActionID *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__ActionID(cdr, ros_message);
}

static uint32_t _ActionID__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__ActionID(
...
static size_t _ActionID__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__ActionID(
...
static message_type_support_callbacks_t __callbacks_ActionID = {
...
static rosidl_message_type_support_t _ActionID__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ActionID,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_etsi_its_msgs, msg, ActionID)() {
  return &_ActionID__type_support;
}
