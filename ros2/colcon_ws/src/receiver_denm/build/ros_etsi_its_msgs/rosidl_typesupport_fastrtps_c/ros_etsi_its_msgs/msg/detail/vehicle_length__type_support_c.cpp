...
#include "ros_etsi_its_msgs/msg/detail/vehicle_length__rosidl_typesupport_fastrtps_c.h"
...
using _VehicleLength__ros_msg_type = ros_etsi_its_msgs__msg__VehicleLength;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: confidence_indication
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_etsi_its_msgs__msg__VehicleLength;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros_etsi_its_msgs__msg__VehicleLength * ros_message = static_cast<const ros_etsi_its_msgs__msg__VehicleLength *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros_etsi_its_msgs__msg__VehicleLength(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros_etsi_its_msgs__msg__VehicleLength * ros_message = static_cast<ros_etsi_its_msgs__msg__VehicleLength *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros_etsi_its_msgs__msg__VehicleLength(cdr, ros_message);
}

static uint32_t _VehicleLength__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_etsi_its_msgs__msg__VehicleLength(
...
static size_t _VehicleLength__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_etsi_its_msgs__msg__VehicleLength(
