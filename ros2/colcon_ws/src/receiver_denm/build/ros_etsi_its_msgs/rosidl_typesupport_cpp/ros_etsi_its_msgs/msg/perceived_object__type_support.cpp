...
static const _PerceivedObject_type_support_symbol_names_t _PerceivedObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_etsi_its_msgs, msg, PerceivedObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_etsi_its_msgs, msg, PerceivedObject)),
  }
};
...
get_message_type_support_handle<ros_etsi_its_msgs::msg::PerceivedObject>()
{
  return &::ros_etsi_its_msgs::msg::rosidl_typesupport_cpp::PerceivedObject_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_etsi_its_msgs, msg, PerceivedObject)() {
  return get_message_type_support_handle<ros_etsi_its_msgs::msg::PerceivedObject>();
}
