...
ros_etsi_its_msgs__msg__StationType__create(void)
{
  ...
  ros_etsi_its_msgs__msg__StationType * msg = (ros_etsi_its_msgs__msg__StationType *)allocator.allocate(sizeof(ros_etsi_its_msgs__msg__StationType), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros_etsi_its_msgs__msg__StationType));
  bool success = ros_etsi_its_msgs__msg__StationType__init(msg);
  if (!success) {
...
ros_etsi_its_msgs__msg__StationType__destroy(ros_etsi_its_msgs__msg__StationType * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ros_etsi_its_msgs__msg__StationType__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ros_etsi_its_msgs__msg__StationType__Sequence__init(ros_etsi_its_msgs__msg__StationType__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_etsi_its_msgs__msg__StationType * data = NULL;

  if (size) {
    data = (ros_etsi_its_msgs__msg__StationType *)allocator.zero_allocate(size, sizeof(ros_etsi_its_msgs__msg__StationType), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros_etsi_its_msgs__msg__StationType__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros_etsi_its_msgs__msg__StationType__fini(&data[i - 1]);
      }
...
ros_etsi_its_msgs__msg__StationType__Sequence__fini(ros_etsi_its_msgs__msg__StationType__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros_etsi_its_msgs__msg__StationType__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_etsi_its_msgs__msg__StationType__Sequence * array = (ros_etsi_its_msgs__msg__StationType__Sequence *)allocator.allocate(sizeof(ros_etsi_its_msgs__msg__StationType__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros_etsi_its_msgs__msg__StationType__Sequence__init(array, size);
  if (!success) {
...
ros_etsi_its_msgs__msg__StationType__Sequence__destroy(ros_etsi_its_msgs__msg__StationType__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros_etsi_its_msgs__msg__StationType__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros_etsi_its_msgs__msg__StationType__Sequence__are_equal(const ros_etsi_its_msgs__msg__StationType__Sequence * lhs, const ros_etsi_its_msgs__msg__StationType__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros_etsi_its_msgs__msg__StationType__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros_etsi_its_msgs__msg__StationType__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros_etsi_its_msgs__msg__StationType);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros_etsi_its_msgs__msg__StationType * data =
      (ros_etsi_its_msgs__msg__StationType *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_etsi_its_msgs__msg__StationType__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros_etsi_its_msgs__msg__StationType__fini(&output->data[i]);
        }
        return false;
      }
    }
