...
static char ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__name[] = "name";
static char ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__id[] = "id";
static char ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__revision[] = "revision";
static char ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__ref_point[] = "ref_point";
static char ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__lane_width[] = "lane_width";
static char ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__lane_set[] = "lane_set";

static rosidl_runtime_c__type_description__Field ros_etsi_its_msgs__msg__IntersectionGeometry__FIELDS[] = {
  {
    {ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__name, 4, 4},
    {
  ...
  {
    {ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__revision, 8, 8},
    {
  ...
  {
    {ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__ref_point, 9, 9},
    {
  ...
  {
    {ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__lane_width, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT16,
      0,
      0,
  ...
  {
    {ros_etsi_its_msgs__msg__IntersectionGeometry__FIELD_NAME__lane_set, 8, 8},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ros_etsi_its_msgs__msg__IntersectionGeometry__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {ros_etsi_its_msgs__msg__IntersectionGeometry__FIELDS, 6, 6},
    },
    {ros_etsi_its_msgs__msg__IntersectionGeometry__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[3].fields = ros_etsi_its_msgs__msg__NodeSetXY__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[4].fields = ros_etsi_its_msgs__msg__PositionConfidenceEllipse__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[5].fields = ros_etsi_its_msgs__msg__ReferencePosition__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  ...
  "uint16 id\n"
  "uint8 revision\n"
  "ReferencePosition ref_point\n"
  "uint16 lane_width\n"
  "GenericLane[] lane_set";
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ros_etsi_its_msgs__msg__IntersectionGeometry__get_individual_type_description_source(NULL),
    ...
    sources[4] = *ros_etsi_its_msgs__msg__NodeSetXY__get_individual_type_description_source(NULL);
    sources[5] = *ros_etsi_its_msgs__msg__PositionConfidenceEllipse__get_individual_type_description_source(NULL);
    sources[6] = *ros_etsi_its_msgs__msg__ReferencePosition__get_individual_type_description_source(NULL);
    constructed = true;
  }
