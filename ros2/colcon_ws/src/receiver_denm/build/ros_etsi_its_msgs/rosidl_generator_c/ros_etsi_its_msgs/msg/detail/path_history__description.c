...
static char ros_etsi_its_msgs__msg__PathHistory__FIELD_NAME__points[] = "points";

static rosidl_runtime_c__type_description__Field ros_etsi_its_msgs__msg__PathHistory__FIELDS[] = {
  {
    {ros_etsi_its_msgs__msg__PathHistory__FIELD_NAME__points, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ros_etsi_its_msgs__msg__PathHistory__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {ros_etsi_its_msgs__msg__PathHistory__FIELDS, 1, 1},
    },
    {ros_etsi_its_msgs__msg__PathHistory__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[2].fields = ros_etsi_its_msgs__msg__PathPoint__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
ros_etsi_its_msgs__msg__PathHistory__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ros_etsi_its_msgs__msg__PathHistory__get_individual_type_description_source(NULL),
    ...
    sources[3] = *ros_etsi_its_msgs__msg__PathPoint__get_individual_type_description_source(NULL);
    constructed = true;
  }
