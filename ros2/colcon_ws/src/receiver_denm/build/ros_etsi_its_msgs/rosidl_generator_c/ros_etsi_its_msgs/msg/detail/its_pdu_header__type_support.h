...
#ifndef ROS_ETSI_ITS_MSGS__MSG__DETAIL__ITS_PDU_HEADER__TYPE_SUPPORT_H_
#define ROS_ETSI_ITS_MSGS__MSG__DETAIL__ITS_PDU_HEADER__TYPE_SUPPORT_H_
...
#endif  // ROS_ETSI_ITS_MSGS__MSG__DETAIL__ITS_PDU_HEADER__TYPE_SUPPORT_H_
