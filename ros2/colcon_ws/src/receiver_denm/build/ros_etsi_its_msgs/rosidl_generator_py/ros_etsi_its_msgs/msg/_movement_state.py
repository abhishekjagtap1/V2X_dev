...
class Metaclass_MovementState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros_etsi_its_msgs.msg import MovementEvent
...
class MovementState(metaclass=Metaclass_MovementState):
    ...
    _fields_and_field_types = {
        'signal_group': 'uint8',
        'state_time_speed': 'sequence<ros_etsi_its_msgs/MovementEvent>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros_etsi_its_msgs', 'msg'], 'MovementEvent')),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.state_time_speed = kwargs.get('state_time_speed', [])
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'state_time_speed' field must be a set or sequence and each value of type 'MovementEvent'"
