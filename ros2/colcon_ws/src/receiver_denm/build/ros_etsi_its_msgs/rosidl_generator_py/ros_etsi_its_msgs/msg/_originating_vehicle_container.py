...
class Metaclass_OriginatingVehicleContainer(type):
    """Metaclass of message 'OriginatingVehicleContainer'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ros_etsi_its_msgs.msg.OriginatingVehicleContainer')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__originating_vehicle_container
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__originating_vehicle_container
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__originating_vehicle_container
            cls._TYPE_SUPPORT = module.type_support_msg__msg__originating_vehicle_container
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__originating_vehicle_container
            ...
            from ros_etsi_its_msgs.msg import WGS84Angle
            if WGS84Angle.__class__._TYPE_SUPPORT is None:
                WGS84Angle.__class__.__import_type_support__()
...
class OriginatingVehicleContainer(metaclass=Metaclass_OriginatingVehicleContainer):
    """Message class 'OriginatingVehicleContainer'."""

    __slots__ = [
        '_heading',
        '_speed',
        '_has_vehicle_orientation_angle',
        '_vehicle_orientation_angle',
        '_drive_direction',
        '_has_vehicle_length',
        '_vehicle_length',
        '_has_vehicle_width',
        ...
        '_has_vehicle_height',
        '_vehicle_height',
        '_has_longitudinal_acceleration',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['ros_etsi_its_msgs', 'msg'], 'WGS84Angle'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.has_vehicle_orientation_angle = kwargs.get('has_vehicle_orientation_angle', bool())
        from ros_etsi_its_msgs.msg import WGS84Angle
        self.vehicle_orientation_angle = kwargs.get('vehicle_orientation_angle', WGS84Angle())
        from ros_etsi_its_msgs.msg import DriveDirection
        self.drive_direction = kwargs.get('drive_direction', DriveDirection())
        self.has_vehicle_length = kwargs.get('has_vehicle_length', bool())
        from ros_etsi_its_msgs.msg import VehicleLength
        self.vehicle_length = kwargs.get('vehicle_length', VehicleLength())
        self.has_vehicle_width = kwargs.get('has_vehicle_width', bool())
        from ros_etsi_its_msgs.msg import VehicleWidth
        self.vehicle_width = kwargs.get('vehicle_width', VehicleWidth())
        self.has_vehicle_height = kwargs.get('has_vehicle_height', bool())
        self.vehicle_height = kwargs.get('vehicle_height', int())
        self.has_longitudinal_acceleration = kwargs.get('has_longitudinal_acceleration', bool())
        from ros_etsi_its_msgs.msg import LongitudinalAcceleration
        self.longitudinal_acceleration = kwargs.get('longitudinal_acceleration', LongitudinalAcceleration())
        self.has_yaw_rate = kwargs.get('has_yaw_rate', bool())
        from ros_etsi_its_msgs.msg import YawRate
    ...
    def __eq__(self, other):
        ...
        if self.speed != other.speed:
            return False
        if self.has_vehicle_orientation_angle != other.has_vehicle_orientation_angle:
            return False
        if self.vehicle_orientation_angle != other.vehicle_orientation_angle:
            return False
        if self.drive_direction != other.drive_direction:
            return False
        if self.has_vehicle_length != other.has_vehicle_length:
            return False
        if self.vehicle_length != other.vehicle_length:
            return False
        if self.has_vehicle_width != other.has_vehicle_width:
            return False
        if self.vehicle_width != other.vehicle_width:
            return False
        if self.has_vehicle_height != other.has_vehicle_height:
            return False
        if self.vehicle_height != other.vehicle_height:
            return False
        if self.has_longitudinal_acceleration != other.has_longitudinal_acceleration:
            return False
        if self.longitudinal_acceleration != other.longitudinal_acceleration:
            return False
        if self.has_yaw_rate != other.has_yaw_rate:
            return False
    ...
    @builtins.property
    def has_vehicle_orientation_angle(self):
        """Message field 'has_vehicle_orientation_angle'."""
        return self._has_vehicle_orientation_angle

    @has_vehicle_orientation_angle.setter
    def has_vehicle_orientation_angle(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'has_vehicle_orientation_angle' field must be of type 'bool'"
        self._has_vehicle_orientation_angle = value

    @builtins.property
    def vehicle_orientation_angle(self):
        """Message field 'vehicle_orientation_angle'."""
        return self._vehicle_orientation_angle

    @vehicle_orientation_angle.setter
    def vehicle_orientation_angle(self, value):
        if self._check_fields:
            from ros_etsi_its_msgs.msg import WGS84Angle
            assert \
                isinstance(value, WGS84Angle), \
                "The 'vehicle_orientation_angle' field must be a sub message of type 'WGS84Angle'"
        self._vehicle_orientation_angle = value
    ...
    @builtins.property
    def has_vehicle_length(self):
        """Message field 'has_vehicle_length'."""
        return self._has_vehicle_length

    @has_vehicle_length.setter
    def has_vehicle_length(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'has_vehicle_length' field must be of type 'bool'"
        self._has_vehicle_length = value
    ...
    @builtins.property
    def has_vehicle_width(self):
        """Message field 'has_vehicle_width'."""
        return self._has_vehicle_width

    @has_vehicle_width.setter
    def has_vehicle_width(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'has_vehicle_width' field must be of type 'bool'"
        self._has_vehicle_width = value
    ...
    @builtins.property
    def has_vehicle_height(self):
        """Message field 'has_vehicle_height'."""
        return self._has_vehicle_height

    @has_vehicle_height.setter
    def has_vehicle_height(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'has_vehicle_height' field must be of type 'bool'"
        self._has_vehicle_height = value
    ...
    @builtins.property
    def has_longitudinal_acceleration(self):
        """Message field 'has_longitudinal_acceleration'."""
        return self._has_longitudinal_acceleration

    @has_longitudinal_acceleration.setter
    def has_longitudinal_acceleration(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'has_longitudinal_acceleration' field must be of type 'bool'"
        self._has_longitudinal_acceleration = value
    ...
    @builtins.property
    def has_yaw_rate(self):
        """Message field 'has_yaw_rate'."""
        return self._has_yaw_rate

    @has_yaw_rate.setter
    def has_yaw_rate(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'has_yaw_rate' field must be of type 'bool'"
        self._has_yaw_rate = value
