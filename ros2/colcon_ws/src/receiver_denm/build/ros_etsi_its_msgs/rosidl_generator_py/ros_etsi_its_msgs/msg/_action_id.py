...
class Metaclass_ActionID(type):
    """Metaclass of message 'ActionID'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ros_etsi_its_msgs.msg.ActionID')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__action_id
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__action_id
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__action_id
            cls._TYPE_SUPPORT = module.type_support_msg__msg__action_id
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__action_id
...
class ActionID(metaclass=Metaclass_ActionID):
    """Message class 'ActionID'."""
