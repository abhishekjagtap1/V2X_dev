...
bool ros_etsi_its_msgs__msg__its_pdu_header__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_etsi_its_msgs.msg._its_pdu_header.ItsPduHeader", full_classname_dest, 50) == 0);
  }
  ros_etsi_its_msgs__msg__ItsPduHeader * ros_message = _ros_message;
  {  // protocol_version
  ...
  {  // message_id
    ...
    assert(PyLong_Check(field));
    ros_message->message_id = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // station_id
...
{
  /* NOTE(esteve): Call constructor of ItsPduHeader */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_etsi_its_msgs.msg._its_pdu_header");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ItsPduHeader");
