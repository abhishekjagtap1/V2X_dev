...
bool v2x_stack__msg__udp_msg_type__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_stack.msg._udp_msg_type.UDPMsgType", full_classname_dest, 38) == 0);
  }
  v2x_stack__msg__UDPMsgType * ros_message = _ros_message;
  {  // version
...
PyObject * v2x_stack__msg__udp_msg_type__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_stack.msg._udp_msg_type");
