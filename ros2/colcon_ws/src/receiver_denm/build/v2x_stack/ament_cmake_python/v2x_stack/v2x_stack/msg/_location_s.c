...
bool v2x_stack__msg__location__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_stack.msg._location.Location", full_classname_dest, 32) == 0);
  }
  v2x_stack__msg__Location * ros_message = _ros_message;
  {  // destination
...
PyObject * v2x_stack__msg__location__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_stack.msg._location");
