...
#include "v2x_stack/msg/detail/geo_net_destination__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const v2x_stack::msg::GeoNetArea &,
...
cdr_serialize(
  const v2x_stack::msg::GeoNetDestination & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_stack::msg::GeoNetDestination & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  size_t current_alignment)
{
  ...
  // Member: area
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_stack::msg::typesupport_fastrtps_cpp::max_serialized_size_GeoNetArea(
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack::msg::GeoNetDestination;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: area
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_stack::msg::typesupport_fastrtps_cpp::max_serialized_size_key_GeoNetArea(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const v2x_stack::msg::GeoNetDestination *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_stack::msg::GeoNetDestination *>(
    untyped_ros_message);
...
{
  return &v2x_stack::msg::typesupport_fastrtps_cpp::_GeoNetDestination__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_stack, msg, GeoNetDestination)() {
  return &v2x_stack::msg::typesupport_fastrtps_cpp::_GeoNetDestination__handle;
}
