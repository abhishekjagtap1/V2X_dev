...
#include "v2x_stack/msg/detail/location__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack::msg::Location;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_stack::msg::Location *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_stack::msg::Location *>(
    untyped_ros_message);
...
{
  return &v2x_stack::msg::typesupport_fastrtps_cpp::_Location__handle;
}
