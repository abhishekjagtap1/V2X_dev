...
#include "v2x_stack/msg/detail/geo_net_area__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_stack::msg::GeoNetArea & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_stack::msg::GeoNetArea & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack::msg::GeoNetArea;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_stack::msg::GeoNetArea *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_stack::msg::GeoNetArea *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GeoNetArea__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const v2x_stack::msg::GeoNetArea *>(
...
static size_t _GeoNetArea__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GeoNetArea(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GeoNetArea__callbacks = {
  "v2x_stack::msg",
  "GeoNetArea",
...
static rosidl_message_type_support_t _GeoNetArea__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GeoNetArea__callbacks,
...
{
  return &v2x_stack::msg::typesupport_fastrtps_cpp::_GeoNetArea__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_stack, msg, GeoNetArea)() {
  return &v2x_stack::msg::typesupport_fastrtps_cpp::_GeoNetArea__handle;
}
