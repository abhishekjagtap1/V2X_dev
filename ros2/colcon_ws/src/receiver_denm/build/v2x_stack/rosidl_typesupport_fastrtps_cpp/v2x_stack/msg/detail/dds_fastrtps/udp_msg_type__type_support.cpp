...
#include "v2x_stack/msg/detail/udp_msg_type__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack::msg::UDPMsgType;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_stack::msg::UDPMsgType *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_stack::msg::UDPMsgType *>(
    untyped_ros_message);
...
{
  return &v2x_stack::msg::typesupport_fastrtps_cpp::_UDPMsgType__handle;
}
