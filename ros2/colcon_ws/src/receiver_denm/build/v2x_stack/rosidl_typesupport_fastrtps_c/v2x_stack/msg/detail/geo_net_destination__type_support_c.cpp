...
#include "v2x_stack/msg/detail/geo_net_destination__rosidl_typesupport_fastrtps_c.h"
...
#include "v2x_stack/msg/detail/geo_net_area__functions.h"  // area

// forward declare type support functions

bool cdr_serialize_v2x_stack__msg__GeoNetArea(
  const v2x_stack__msg__GeoNetArea * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_v2x_stack__msg__GeoNetArea(
  eprosima::fastcdr::Cdr & cdr,
  v2x_stack__msg__GeoNetArea * ros_message);

size_t get_serialized_size_v2x_stack__msg__GeoNetArea(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_v2x_stack__msg__GeoNetArea(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

bool cdr_serialize_key_v2x_stack__msg__GeoNetArea(
  const v2x_stack__msg__GeoNetArea * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_v2x_stack__msg__GeoNetArea(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_v2x_stack__msg__GeoNetArea(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_stack, msg, GeoNetArea)();


using _GeoNetDestination__ros_msg_type = v2x_stack__msg__GeoNetDestination;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: area
  {
    cdr_serialize_v2x_stack__msg__GeoNetArea(
  ...
  v2x_stack__msg__GeoNetDestination * ros_message)
{
  ...
  // Field name: area
  {
    cdr_deserialize_v2x_stack__msg__GeoNetArea(cdr, &ros_message->area);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: area
  current_alignment += get_serialized_size_v2x_stack__msg__GeoNetArea(
  ...
  size_t current_alignment)
{
  ...
  // Field name: area
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_v2x_stack__msg__GeoNetArea(
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack__msg__GeoNetDestination;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: area
  {
    cdr_serialize_key_v2x_stack__msg__GeoNetArea(
      &ros_message->area, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: area
  current_alignment += get_serialized_size_key_v2x_stack__msg__GeoNetArea(
    &(ros_message->area), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: area
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_v2x_stack__msg__GeoNetArea(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const v2x_stack__msg__GeoNetDestination * ros_message = static_cast<const v2x_stack__msg__GeoNetDestination *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_v2x_stack__msg__GeoNetDestination(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  v2x_stack__msg__GeoNetDestination * ros_message = static_cast<v2x_stack__msg__GeoNetDestination *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_v2x_stack__msg__GeoNetDestination(cdr, ros_message);
}

static uint32_t _GeoNetDestination__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_stack__msg__GeoNetDestination(
...
static size_t _GeoNetDestination__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_v2x_stack__msg__GeoNetDestination(
