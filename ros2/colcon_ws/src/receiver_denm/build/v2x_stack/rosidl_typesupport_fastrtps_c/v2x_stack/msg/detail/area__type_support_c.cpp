...
#include "v2x_stack/msg/detail/area__rosidl_typesupport_fastrtps_c.h"
...
using _Area__ros_msg_type = v2x_stack__msg__Area;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack__msg__Area;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const v2x_stack__msg__Area * ros_message = static_cast<const v2x_stack__msg__Area *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_v2x_stack__msg__Area(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  v2x_stack__msg__Area * ros_message = static_cast<v2x_stack__msg__Area *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_v2x_stack__msg__Area(cdr, ros_message);
}

static uint32_t _Area__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_stack__msg__Area(
...
static size_t _Area__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_v2x_stack__msg__Area(
