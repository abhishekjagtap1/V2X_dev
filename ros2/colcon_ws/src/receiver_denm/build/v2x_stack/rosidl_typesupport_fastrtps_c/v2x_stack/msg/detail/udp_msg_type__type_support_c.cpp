...
#include "v2x_stack/msg/detail/udp_msg_type__rosidl_typesupport_fastrtps_c.h"
...
using _UDPMsgType__ros_msg_type = v2x_stack__msg__UDPMsgType;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack__msg__UDPMsgType;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const v2x_stack__msg__UDPMsgType * ros_message = static_cast<const v2x_stack__msg__UDPMsgType *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_v2x_stack__msg__UDPMsgType(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  v2x_stack__msg__UDPMsgType * ros_message = static_cast<v2x_stack__msg__UDPMsgType *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_v2x_stack__msg__UDPMsgType(cdr, ros_message);
}

static uint32_t _UDPMsgType__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_stack__msg__UDPMsgType(
...
static size_t _UDPMsgType__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_v2x_stack__msg__UDPMsgType(
