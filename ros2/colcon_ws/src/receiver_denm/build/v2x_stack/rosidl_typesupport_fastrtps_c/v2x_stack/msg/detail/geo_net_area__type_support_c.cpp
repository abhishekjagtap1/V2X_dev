...
#include "v2x_stack/msg/detail/geo_net_area__rosidl_typesupport_fastrtps_c.h"
...
using _GeoNetArea__ros_msg_type = v2x_stack__msg__GeoNetArea;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack__msg__GeoNetArea;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const v2x_stack__msg__GeoNetArea * ros_message = static_cast<const v2x_stack__msg__GeoNetArea *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_v2x_stack__msg__GeoNetArea(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  v2x_stack__msg__GeoNetArea * ros_message = static_cast<v2x_stack__msg__GeoNetArea *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_v2x_stack__msg__GeoNetArea(cdr, ros_message);
}

static uint32_t _GeoNetArea__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_stack__msg__GeoNetArea(
...
static size_t _GeoNetArea__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_v2x_stack__msg__GeoNetArea(
