...
static const _UDPDataIndHdr_type_support_symbol_names_t _UDPDataIndHdr_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_stack, msg, UDPDataIndHdr)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2x_stack, msg, UDPDataIndHdr)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, v2x_stack, msg, UDPDataIndHdr)() {
  return &::v2x_stack::msg::rosidl_typesupport_c::UDPDataIndHdr_message_type_support_handle;
}
