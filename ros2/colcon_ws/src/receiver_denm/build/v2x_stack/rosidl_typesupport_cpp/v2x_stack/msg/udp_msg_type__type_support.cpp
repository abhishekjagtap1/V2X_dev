...
static const _UDPMsgType_type_support_symbol_names_t _UDPMsgType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_stack, msg, UDPMsgType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2x_stack, msg, UDPMsgType)),
  }
};
...
{
  return &::v2x_stack::msg::rosidl_typesupport_cpp::UDPMsgType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, v2x_stack, msg, UDPMsgType)() {
  return get_message_type_support_handle<v2x_stack::msg::UDPMsgType>();
}
