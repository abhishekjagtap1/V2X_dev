...
{
  new (message_memory) v2x_stack::msg::UDPMsgType(_init);
}

void UDPMsgType_fini_function(void * message_memory)
{
  auto typed_message = static_cast<v2x_stack::msg::UDPMsgType *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UDPMsgType_message_member_array[3] = {
  {
    ...
    offsetof(v2x_stack::msg::UDPMsgType, version),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_stack::msg::UDPMsgType, msg_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(v2x_stack::msg::UDPMsgType, msg_length),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers UDPMsgType_message_members = {
  ...
  3,  // number of fields
  sizeof(v2x_stack::msg::UDPMsgType),
...
get_message_type_support_handle<v2x_stack::msg::UDPMsgType>()
{
  return &::v2x_stack::msg::rosidl_typesupport_introspection_cpp::UDPMsgType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2x_stack, msg, UDPMsgType)() {
  return &::v2x_stack::msg::rosidl_typesupport_introspection_cpp::UDPMsgType_message_type_support_handle;
}
