...
#ifndef V2X_STACK__MSG__DETAIL__AREA__TRAITS_HPP_
#define V2X_STACK__MSG__DETAIL__AREA__TRAITS_HPP_
...
inline std::string to_yaml(const v2x_stack::msg::Area & msg)
{
  return v2x_stack::msg::to_yaml(msg);
}

template<>
inline const char * data_type<v2x_stack::msg::Area>()
{
  return "v2x_stack::msg::Area";
}

template<>
inline const char * name<v2x_stack::msg::Area>()
{
  return "v2x_stack/msg/Area";
}

template<>
struct has_fixed_size<v2x_stack::msg::Area>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<v2x_stack::msg::Area>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<v2x_stack::msg::Area>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // V2X_STACK__MSG__DETAIL__AREA__TRAITS_HPP_
