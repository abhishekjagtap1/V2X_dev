...
#ifndef V2X_STACK__MSG__DETAIL__GEO_NET_DESTINATION__TYPE_SUPPORT_H_
#define V2X_STACK__MSG__DETAIL__GEO_NET_DESTINATION__TYPE_SUPPORT_H_
...
#endif  // V2X_STACK__MSG__DETAIL__GEO_NET_DESTINATION__TYPE_SUPPORT_H_
