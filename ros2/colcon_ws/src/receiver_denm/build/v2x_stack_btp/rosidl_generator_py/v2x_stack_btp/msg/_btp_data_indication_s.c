...
bool v2x_stack_btp__msg__btp_data_indication__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_stack_btp.msg._btp_data_indication.BtpDataIndication", full_classname_dest, 56) == 0);
  }
  v2x_stack_btp__msg__BtpDataIndication * ros_message = _ros_message;
  {  // header
  ...
  {  // permissions
    PyObject * field = PyObject_GetAttrString(_pymsg, "permissions");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->permissions.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'permissions'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // remaining_packet_lifetime
    PyObject * field = PyObject_GetAttrString(_pymsg, "remaining_packet_lifetime");
    if (!field) {
      return false;
    }
    if (!builtin_interfaces__msg__duration__convert_from_py(field, &ros_message->remaining_packet_lifetime)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of BtpDataIndication */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_stack_btp.msg._btp_data_indication");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BtpDataIndication");
  ...
  {  // permissions
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "permissions");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->permissions.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->permissions.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->permissions.size * sizeof(uint8_t));
      assert(data != NULL);
  ...
  {  // remaining_packet_lifetime
    PyObject * field = NULL;
    field = builtin_interfaces__msg__duration__convert_to_py(&ros_message->remaining_packet_lifetime);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "remaining_packet_lifetime", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
