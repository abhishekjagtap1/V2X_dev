...
#ifndef V2X_STACK_BTP__MSG__DETAIL__GEO_NET_AREA__FUNCTIONS_H_
#define V2X_STACK_BTP__MSG__DETAIL__GEO_NET_AREA__FUNCTIONS_H_
 ...
 * )) before or use
 * v2x_stack_btp__msg__GeoNetArea__create()
 ...
 * calls
 * v2x_stack_btp__msg__GeoNetArea__init().
...
/**
 * It calls
 * v2x_stack_btp__msg__GeoNetArea__fini()
 ...
 * v2x_stack_btp__msg__GeoNetArea__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * v2x_stack_btp__msg__GeoNetArea__Sequence__fini()
 * on the array,
...
#endif  // V2X_STACK_BTP__MSG__DETAIL__GEO_NET_AREA__FUNCTIONS_H_
