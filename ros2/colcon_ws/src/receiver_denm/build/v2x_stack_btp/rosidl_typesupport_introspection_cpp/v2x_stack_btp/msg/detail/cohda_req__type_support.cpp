...
{
  new (message_memory) v2x_stack_btp::msg::CohdaReq(_init);
}

void CohdaReq_fini_function(void * message_memory)
{
  auto typed_message = static_cast<v2x_stack_btp::msg::CohdaReq *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CohdaReq_message_member_array[1] = {
  {
    ...
    offsetof(v2x_stack_btp::msg::CohdaReq, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CohdaReq_message_members = {
  ...
  1,  // number of fields
  sizeof(v2x_stack_btp::msg::CohdaReq),
...
{
  return &::v2x_stack_btp::msg::rosidl_typesupport_introspection_cpp::CohdaReq_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, v2x_stack_btp, msg, CohdaReq)() {
  return &::v2x_stack_btp::msg::rosidl_typesupport_introspection_cpp::CohdaReq_message_type_support_handle;
}
