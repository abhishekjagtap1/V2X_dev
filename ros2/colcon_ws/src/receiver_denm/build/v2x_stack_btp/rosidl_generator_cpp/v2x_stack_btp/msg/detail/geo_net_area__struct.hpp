...
#ifndef V2X_STACK_BTP__MSG__DETAIL__GEO_NET_AREA__STRUCT_HPP_
#define V2X_STACK_BTP__MSG__DETAIL__GEO_NET_AREA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__v2x_stack_btp__msg__GeoNetArea __attribute__((deprecated))
#else
# define DEPRECATED__v2x_stack_btp__msg__GeoNetArea __declspec(deprecated)
#endif
...
struct GeoNetArea_
{
  ...
  using ConstRawPtr =
    const v2x_stack_btp::msg::GeoNetArea_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<v2x_stack_btp::msg::GeoNetArea_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<v2x_stack_btp::msg::GeoNetArea_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      v2x_stack_btp::msg::GeoNetArea_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<v2x_stack_btp::msg::GeoNetArea_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<v2x_stack_btp::msg::GeoNetArea_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<v2x_stack_btp::msg::GeoNetArea_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<v2x_stack_btp::msg::GeoNetArea_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__v2x_stack_btp__msg__GeoNetArea
    std::shared_ptr<v2x_stack_btp::msg::GeoNetArea_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__v2x_stack_btp__msg__GeoNetArea
    std::shared_ptr<v2x_stack_btp::msg::GeoNetArea_<ContainerAllocator> const>
...
using GeoNetArea =
  v2x_stack_btp::msg::GeoNetArea_<std::allocator<void>>;
...
#endif  // V2X_STACK_BTP__MSG__DETAIL__GEO_NET_AREA__STRUCT_HPP_
