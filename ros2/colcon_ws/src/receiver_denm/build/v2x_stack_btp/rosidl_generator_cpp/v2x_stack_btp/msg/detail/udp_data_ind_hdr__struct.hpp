...
#ifndef V2X_STACK_BTP__MSG__DETAIL__UDP_DATA_IND_HDR__STRUCT_HPP_
#define V2X_STACK_BTP__MSG__DETAIL__UDP_DATA_IND_HDR__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__v2x_stack_btp__msg__UDPDataIndHdr __attribute__((deprecated))
#else
# define DEPRECATED__v2x_stack_btp__msg__UDPDataIndHdr __declspec(deprecated)
#endif
...
struct UDPDataIndHdr_
{
  ...
  Type & set__location(
    const v2x_stack_btp::msg::Location_<ContainerAllocator> & _arg)
  {
    this->location = _arg;
    return *this;
  }
  Type & set__area(
    const v2x_stack_btp::msg::Area_<ContainerAllocator> & _arg)
  {
    this->area = _arg;
    return *this;
  }
  ...
  using ConstRawPtr =
    const v2x_stack_btp::msg::UDPDataIndHdr_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<v2x_stack_btp::msg::UDPDataIndHdr_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<v2x_stack_btp::msg::UDPDataIndHdr_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      v2x_stack_btp::msg::UDPDataIndHdr_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<v2x_stack_btp::msg::UDPDataIndHdr_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<v2x_stack_btp::msg::UDPDataIndHdr_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<v2x_stack_btp::msg::UDPDataIndHdr_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<v2x_stack_btp::msg::UDPDataIndHdr_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__v2x_stack_btp__msg__UDPDataIndHdr
    std::shared_ptr<v2x_stack_btp::msg::UDPDataIndHdr_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__v2x_stack_btp__msg__UDPDataIndHdr
    std::shared_ptr<v2x_stack_btp::msg::UDPDataIndHdr_<ContainerAllocator> const>
...
using UDPDataIndHdr =
  v2x_stack_btp::msg::UDPDataIndHdr_<std::allocator<void>>;
...
#endif  // V2X_STACK_BTP__MSG__DETAIL__UDP_DATA_IND_HDR__STRUCT_HPP_
