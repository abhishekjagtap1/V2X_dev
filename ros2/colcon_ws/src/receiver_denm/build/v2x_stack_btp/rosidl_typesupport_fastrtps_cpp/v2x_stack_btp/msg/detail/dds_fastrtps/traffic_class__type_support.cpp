...
#include "v2x_stack_btp/msg/detail/traffic_class__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_stack_btp::msg::TrafficClass & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_stack_btp::msg::TrafficClass & ros_message)
{
  // Member: store_carry_forwarding
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack_btp::msg::TrafficClass;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_stack_btp::msg::TrafficClass *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_stack_btp::msg::TrafficClass *>(
    untyped_ros_message);
...
{
  return &v2x_stack_btp::msg::typesupport_fastrtps_cpp::_TrafficClass__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_stack_btp, msg, TrafficClass)() {
  return &v2x_stack_btp::msg::typesupport_fastrtps_cpp::_TrafficClass__handle;
}
