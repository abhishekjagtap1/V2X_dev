...
#include "v2x_stack_btp/msg/detail/udp_data_ind_hdr__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const v2x_stack_btp::msg::Location &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  v2x_stack_btp::msg::Location &);
  ...
  size_t current_alignment)
{
  ...
  // Member: location
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_stack_btp::msg::typesupport_fastrtps_cpp::max_serialized_size_Location(
  ...
  // Member: area
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_stack_btp::msg::typesupport_fastrtps_cpp::max_serialized_size_Area(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack_btp::msg::UDPDataIndHdr;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: location
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_stack_btp::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Location(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: area
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        v2x_stack_btp::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Area(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const v2x_stack_btp::msg::UDPDataIndHdr *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_stack_btp::msg::UDPDataIndHdr *>(
    untyped_ros_message);
...
{
  return &v2x_stack_btp::msg::typesupport_fastrtps_cpp::_UDPDataIndHdr__handle;
}
