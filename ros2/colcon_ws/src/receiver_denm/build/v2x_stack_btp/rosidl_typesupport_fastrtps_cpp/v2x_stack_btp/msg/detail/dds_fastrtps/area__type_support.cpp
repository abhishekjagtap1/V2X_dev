...
#include "v2x_stack_btp/msg/detail/area__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const v2x_stack_btp::msg::Area & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  v2x_stack_btp::msg::Area & ros_message)
{
  // Member: latitude
  cdr >> ros_message.latitude;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack_btp::msg::Area;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const v2x_stack_btp::msg::Area *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<v2x_stack_btp::msg::Area *>(
    untyped_ros_message);
...
{
  return &v2x_stack_btp::msg::typesupport_fastrtps_cpp::_Area__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, v2x_stack_btp, msg, Area)() {
  return &v2x_stack_btp::msg::typesupport_fastrtps_cpp::_Area__handle;
}
