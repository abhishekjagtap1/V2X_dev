...
bool v2x_stack_btp__msg__udp_data_ind_hdr__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("v2x_stack_btp.msg._udp_data_ind_hdr.UDPDataIndHdr", full_classname_dest, 49) == 0);
  }
  v2x_stack_btp__msg__UDPDataIndHdr * ros_message = _ros_message;
  {  // btp_type
  ...
  {  // location
    ...
    if (!v2x_stack_btp__msg__location__convert_from_py(field, &ros_message->location)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // area
    ...
    if (!v2x_stack_btp__msg__area__convert_from_py(field, &ros_message->area)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * v2x_stack_btp__msg__udp_data_ind_hdr__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("v2x_stack_btp.msg._udp_data_ind_hdr");
  ...
  {  // location
    PyObject * field = NULL;
    field = v2x_stack_btp__msg__location__convert_to_py(&ros_message->location);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // area
    PyObject * field = NULL;
    field = v2x_stack_btp__msg__area__convert_to_py(&ros_message->area);
    if (!field) {
      return NULL;
    }
    {
