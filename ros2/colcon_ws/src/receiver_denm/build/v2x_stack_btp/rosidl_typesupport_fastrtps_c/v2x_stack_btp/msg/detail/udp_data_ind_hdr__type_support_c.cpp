...
#include "v2x_stack_btp/msg/detail/udp_data_ind_hdr__rosidl_typesupport_fastrtps_c.h"
...
#include "v2x_stack_btp/msg/detail/area__functions.h"  // area
#include "v2x_stack_btp/msg/detail/location__functions.h"  // location

// forward declare type support functions

bool cdr_serialize_v2x_stack_btp__msg__Area(
  const v2x_stack_btp__msg__Area * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_v2x_stack_btp__msg__Area(
  eprosima::fastcdr::Cdr & cdr,
  v2x_stack_btp__msg__Area * ros_message);

size_t get_serialized_size_v2x_stack_btp__msg__Area(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_v2x_stack_btp__msg__Area(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

bool cdr_serialize_key_v2x_stack_btp__msg__Area(
  const v2x_stack_btp__msg__Area * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_v2x_stack_btp__msg__Area(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_v2x_stack_btp__msg__Area(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_stack_btp, msg, Area)();

bool cdr_serialize_v2x_stack_btp__msg__Location(
  const v2x_stack_btp__msg__Location * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_v2x_stack_btp__msg__Location(
  eprosima::fastcdr::Cdr & cdr,
  v2x_stack_btp__msg__Location * ros_message);

size_t get_serialized_size_v2x_stack_btp__msg__Location(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_v2x_stack_btp__msg__Location(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

bool cdr_serialize_key_v2x_stack_btp__msg__Location(
  const v2x_stack_btp__msg__Location * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_v2x_stack_btp__msg__Location(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_v2x_stack_btp__msg__Location(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_stack_btp, msg, Location)();


using _UDPDataIndHdr__ros_msg_type = v2x_stack_btp__msg__UDPDataIndHdr;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: location
  {
    cdr_serialize_v2x_stack_btp__msg__Location(
      &ros_message->location, cdr);
  }

  // Field name: area
  {
    cdr_serialize_v2x_stack_btp__msg__Area(
  ...
  v2x_stack_btp__msg__UDPDataIndHdr * ros_message)
{
  ...
  // Field name: location
  {
    cdr_deserialize_v2x_stack_btp__msg__Location(cdr, &ros_message->location);
  }

  // Field name: area
  {
    cdr_deserialize_v2x_stack_btp__msg__Area(cdr, &ros_message->area);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: location
  current_alignment += get_serialized_size_v2x_stack_btp__msg__Location(
    &(ros_message->location), current_alignment);

  // Field name: area
  current_alignment += get_serialized_size_v2x_stack_btp__msg__Area(
  ...
  size_t current_alignment)
{
  ...
  // Field name: location
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_v2x_stack_btp__msg__Location(
  ...
  // Field name: area
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_v2x_stack_btp__msg__Area(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = v2x_stack_btp__msg__UDPDataIndHdr;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: location
  {
    cdr_serialize_key_v2x_stack_btp__msg__Location(
      &ros_message->location, cdr);
  }

  // Field name: area
  {
    cdr_serialize_key_v2x_stack_btp__msg__Area(
      &ros_message->area, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: location
  current_alignment += get_serialized_size_key_v2x_stack_btp__msg__Location(
    &(ros_message->location), current_alignment);

  // Field name: area
  current_alignment += get_serialized_size_key_v2x_stack_btp__msg__Area(
    &(ros_message->area), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: location
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_v2x_stack_btp__msg__Location(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: area
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_v2x_stack_btp__msg__Area(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const v2x_stack_btp__msg__UDPDataIndHdr * ros_message = static_cast<const v2x_stack_btp__msg__UDPDataIndHdr *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_v2x_stack_btp__msg__UDPDataIndHdr(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  v2x_stack_btp__msg__UDPDataIndHdr * ros_message = static_cast<v2x_stack_btp__msg__UDPDataIndHdr *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_v2x_stack_btp__msg__UDPDataIndHdr(cdr, ros_message);
}

static uint32_t _UDPDataIndHdr__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_v2x_stack_btp__msg__UDPDataIndHdr(
...
static size_t _UDPDataIndHdr__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_v2x_stack_btp__msg__UDPDataIndHdr(
