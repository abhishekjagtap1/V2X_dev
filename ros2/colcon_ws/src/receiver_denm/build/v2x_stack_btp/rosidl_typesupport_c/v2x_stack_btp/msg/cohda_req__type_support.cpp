...
static const _CohdaReq_type_support_symbol_names_t _CohdaReq_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_stack_btp, msg, CohdaReq)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2x_stack_btp, msg, CohdaReq)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, v2x_stack_btp, msg, CohdaReq)() {
  return &::v2x_stack_btp::msg::rosidl_typesupport_c::CohdaReq_message_type_support_handle;
}
