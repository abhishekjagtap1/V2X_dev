...
static const _UDPMsgType_type_support_symbol_names_t _UDPMsgType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, v2x_stack_btp, msg, UDPMsgType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, v2x_stack_btp, msg, UDPMsgType)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, v2x_stack_btp, msg, UDPMsgType)() {
  return &::v2x_stack_btp::msg::rosidl_typesupport_c::UDPMsgType_message_type_support_handle;
}
